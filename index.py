...
def index():
    ...
    homepage += "<br><a href=/movie1>爬蟲</a><br>"
...
def movie():
    ...
    for item in result:
        R += item.find("img").get("alt")
        R += "https://www.atmovies.com.tw"+ item.find("a").get("href")
        R += "https://www.atmovies.com.tw"+ item.find("img").get("src")
    return R
